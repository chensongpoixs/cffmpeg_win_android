...
VideoState::VideoState()
{
	...
	videoq           = new PacketQueue();   //创建保存Vedio packet  队列 对象

	frame_timer      = 0.0; //当前的时间
...
void VideoState::video_play(MediaState *media)
{
	...
	int height = 600;
	// 创建sdl窗口
	window = SDL_CreateWindow("songli ffmpeg player", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
